#!/bin/bash
# CrewAI Gmail Virtual Environment Setup Script
...
echo "  python crewai_mail_test.py"
echo ""
echo -e "${YELLOW}💡 Tip: Make sure you have credentials.json configured!${NC}"
