...
def print_usage():
    ...
    print("🔍 Inspector Agent - Agent System Structure Scanner")
    print("\nUsage:")
    print("  python cli.py <target_path> [options]")
    print("  python cli.py --analyze-graph <graph_file> [options]")
    print("  python cli.py --analyze-logs <log_file> [options]")
    print("\nArguments:")
