...
def print_usage():
    ...
    print("\nExamples:")
    print("  sentinelagent ../crewai_gmail")
    print("  sentinelagent ../crewai_gmail --output gmail_scan.json")
    print("  sentinelagent ../crewai_gmail --graph gmail_graph.json")
    print("  sentinelagent ../crewai_gmail --paths gmail_paths.json") 
    print("  sentinelagent ../crewai_gmail --all")
    print("  sentinelagent --analyze-graph gmail_graph.json")
    print("  sentinelagent --analyze-logs ../autogen_magneticone/logs/log_2025-05-17_17-47-03.txt")
    print("  sentinelagent --analyze-logs ../magentic-one-file-code-execution.csv --log-format csv")
